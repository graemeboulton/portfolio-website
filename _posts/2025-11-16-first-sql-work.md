...
Below is the SQL itself, and here’s a <a href="https://graemeboulton.github.io/portfolio/assets/files/trading_calendar.csv" download>link</a> to the output in CSV format.
